...
class Config_Reader:
    ...
    def read(self):
        ...
        self.elastic_apm_server = self.cr.get(
            'elastic-apm', 'server', fallback='https://localhost:8200')

        self.dev_username = self.cr.get(
            'dev', 'username', fallback='cb-manager')
        self.dev_password = self.cr.get(
            'dev', 'password', fallback='9c804f2550e31d8f98ac9b460cfe7fbfc676c5e4452a261a2899a1ea168c0a50')  # astrid in sha256
