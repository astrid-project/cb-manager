...
api.add_route('/data', connection)
api.add_route('/config/exec-env', connection)
api.add_route('/config/exec-env-type', connection)
api.add_route('/network-link', network_link)
api.add_route('/network-link-type', network_link_type)
