...
class BaseResource(object):
    ...
    def on_post(self, req, resp):
        ...
        try:
            ...
            raise falcon.HTTPConflict(title='f{self.name} already found', description=f'id={id} already present')

    def on_delete(self, req, resp):
        try:
            resp.media = QueryParser(index=self.name).parse(
    ...
    def on_put(self, req, resp):
        ...
        try:
            ...
            raise falcon.HTTPNotFound(title=f'{self.doc_cls.name} not found',
