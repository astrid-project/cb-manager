...
if args.version is not None:
    ...
    from route import AgentCatalog, AgentInstance, Connection, ExecEnv, ExecEnvType, NetworkLink, NetworkLinkType

    for Route in AgentCatalog, AgentInstance, Connection, Data, ExecEnv, ExecEnvType, NetworkLink, NetworkLinkType:
        route = Route()
        api.add_route(route.doc_cls.init'/config/catalog', route)
