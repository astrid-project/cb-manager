...
class LCPSchema(Schema):
    port = fields.Integer(required=True, description='TCP port number of LCP in the execution environment.',
                          example=5000)
    username = fields.String(description='Username to connect from the CB to the LCP.',
                            example='22c6d368beabf9de1ea03e010010758a394c37c3b18aa0705b8634f5')
    password = fields.String(description='Password to connect from the CB to the LCP.',
                            example='22c6d368beabf9de1ea03e010010758a394c37c3b18aa0705b8634f5')
    cb_password = fields.String(description='Hashed password assigned to LCP to connect with the CB.',
                                example='22c6d368beabf9de1ea03e010010758a394c37c3b18aa0705b8634f5')
    cb_expiration = fields.DateTime(description='Datetime until the authentication with the CB is valid.',
